  ...
  return (
    ...
    <div className="flex flex-col md:flex-row justify-center items-center ">
      <div className="w-full md:w-1/2 flex flex-col items-center md:items-start md:mt-0 mt-10 ">
        <h1 className="font-bold text-[32px] text-center md:text-left w-[496px] md:text-[40px] ">
      ...
      <div className="flex flex-col justify-center items-center p-6 md:p-2 mt-5 md:mt-10  overflow-hidden ">
        <Image
